...
var isLocalEnabled = function isLocalEnabled() {
    return !(0, _isEnvVarTrue2.default)('BROWSERSTACK_NO_LOCAL');
};
...
exports.default = {
    ...
    _getAdditionalCapabilities: function _getAdditionalCapabilities() {
        ...
        var capabilitiesFromEnvironment = [['build', process.env['BROWSERSTACK_BUILD_ID']], ['project', process.env['BROWSERSTACK_PROJECT_NAME']], ['resolution', process.env['BROWSERSTACK_DISPLAY_RESOLUTION']], ['browserstack.debug', process.env['BROWSERSTACK_DEBUG']], ['browserstack.console', process.env['BROWSERSTACK_CONSOLE']], ['browserstack.networkLogs', process.env['BROWSERSTACK_NETWORK_LOGS']], ['browserstack.video', process.env['BROWSERSTACK_VIDEO']], ['browserstack.timezone', process.env['BROWSERSTACK_TIMEZONE']]];
